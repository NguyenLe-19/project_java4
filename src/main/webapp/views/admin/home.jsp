		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="HomeController" class="nav-link">Home</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Contact</a></li>
					<li class="nav-item d-none d-sm-inline-block"><a href="user/index"
					class="nav-link">Manage User</a></li>
					<li class="nav-item d-none d-sm-inline-block"><a href="video/index"
					class="nav-link">Manage Video</a></li>
		...
		$(function() {
			...
			$('#selectVideo').change(function(){
			    ...
			    $.ajax({
			        ...
			        // Lặp qua danh sách người dùng và thêm thông tin vào bảng
